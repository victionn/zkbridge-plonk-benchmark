...
var MockLink = /** @class */ (function (_super) {
        ...
        if (!response) {
            ...
            if (newData) {
                if (globalThis.__DEV__ !== false) {
                    globalThis.__DEV__ !== false && invariant.warn(99, response);
                }
    ...
    MockLink.prototype.normalizeMockedResponse = function (mockedResponse) {
        ...
        invariant(queryWithoutClientOnlyDirectives, 101);
        ...
        invariant(mockedResponse.maxUsageCount > 0, 102, mockedResponse.maxUsageCount);
