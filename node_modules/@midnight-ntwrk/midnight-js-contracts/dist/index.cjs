...
const zswapStateToOffer = (zswapLocalState, encryptionPublicKey, params) => {
    ...
    zswapLocalState.inputs.forEach((qualifiedCoinInfo) => {
        ...
        if (unprovenOutput) {
            unprovenTransients.set(serializedCoinInfo, ledger.UnprovenTransient.newFromContractOwnedOutput(qualifiedCoinInfo, 1, unprovenOutput));
            ...
            unprovenInputs.set(serializedCoinInfo, ledger.UnprovenInput.newContractOwned(qualifiedCoinInfo, 1, params.contractAddress, params.zswapChainState));
        }
    });
